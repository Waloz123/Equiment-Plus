...
public enum ModArmorMaterials implements ArmorMaterial {
    AMETHYST("amethyst", 18, Util.make(new EnumMap<>(ArmorItem.Type.class), (p_266654_) -> {
        p_266654_.put(ArmorItem.Type.BOOTS, 2);
        p_266654_.put(ArmorItem.Type.LEGGINGS, 4);
        p_266654_.put(ArmorItem.Type.CHESTPLATE, 6);
        p_266654_.put(ArmorItem.Type.HELMET, 1);
    }), 19, SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
